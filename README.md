...
graph TD
  ...
  B00[08 Pós processamento offline] --> B01[09 Acessar pasta de dados e listar arquivos anuais]
  B00[08 Pós processamento offline] --> B02[10 Verificar alinhamento igual entre anos CRS resolucao origem do pixel extent]
  B00[08 Pós processamento offline] --> B03[11 Definir grade de blocos em pixels ex TILE PX 32 ou 64]
  B00[08 Pós processamento offline] --> B04[12 Ler por bloco todos os anos formando serie mensal por pixel]
  B00[08 Pós processamento offline] --> B05[13 Checar cobertura se pouco dado pular bloco]
  B00[08 Pós processamento offline] --> B06[14 Remover sazonalidade subtrair climatologia mensal por pixel]
